...
export class DELTA_LOG_LOGRADOURO_STREAM extends AbstractStream {
  /**
   *
  ...
  static async run(options) {
    const filePath = `${cwd()}/eDNE_Basico/eDNE_Delta_Basico_23011/Delimitado/DELTA_LOG_LOGRADOURO.TXT`;
    ...
    streamLoop: for await (const line of readLine) {
      ...
      switch (operation) {
        ...
        case "UPD":
          ...
          break;
        case "DEL":
          await options.infra.DELETE_FROM_LOG_LOGRADOURO(data[0]);
          break;
